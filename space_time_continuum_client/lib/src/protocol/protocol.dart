...
import 'historical_lieux.dart' as _i6;
import 'historical_local_dates.dart' as _i7;
import 'historical_mois.dart' as _i8;
import 'organisations.dart' as _i9;
import 'pays.dart' as _i10;
import 'people.dart' as _i11;
...
import 'package:space_time_continuum_client/src/protocol/organisations.dart'
    as _i19;
import 'package:space_time_continuum_client/src/protocol/pays.dart' as _i20;
import 'package:space_time_continuum_client/src/protocol/people.dart' as _i21;
import 'package:space_time_continuum_client/src/protocol/places.dart' as _i22;
import 'package:space_time_continuum_client/src/protocol/terms.dart' as _i23;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.HistoricalLocalDates) {
      return _i7.HistoricalLocalDates.fromJson(data, this) as T;
    }
    if (t == _i8.HistoricalMois) {
      return _i8.HistoricalMois.fromJson(data, this) as T;
    }
    if (t == _i9.Organisations) {
      return _i9.Organisations.fromJson(data, this) as T;
    }
    if (t == _i10.Pays) {
      return _i10.Pays.fromJson(data, this) as T;
    }
    if (t == _i11.People) {
      return _i11.People.fromJson(data, this) as T;
    }
    if (t == _i12.Places) {
    ...
    if (t == _i1.getType<_i7.HistoricalLocalDates?>()) {
      return (data != null
          ? _i7.HistoricalLocalDates.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i8.HistoricalMois?>()) {
      return (data != null ? _i8.HistoricalMois.fromJson(data, this) : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i10.Pays?>()) {
      return (data != null ? _i10.Pays.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i11.People?>()) {
      return (data != null ? _i11.People.fromJson(data, this) : null) as T;
    }
    ...
    if (t == List<_i14.AtThatTime>) {
      return (data as List).map((e) => deserialize<_i14.AtThatTime>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i16.HistoricalJours>) {
      return (data as List)
          .map((e) => deserialize<_i16.HistoricalJours>(e))
          .toList() as dynamic;
    }
    if (t == List<_i17.HistoricalLocalDates>) {
      return (data as List)
          .map((e) => deserialize<_i17.HistoricalLocalDates>(e))
          .toList() as dynamic;
    }
    if (t == List<_i18.HistoricalMois>) {
      return (data as List)
          .map((e) => deserialize<_i18.HistoricalMois>(e))
          .toList() as dynamic;
    }
    ...
    if (t == List<_i20.Pays>) {
      return (data as List).map((e) => deserialize<_i20.Pays>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i23.Terms>) {
      return (data as List).map((e) => deserialize<_i23.Terms>(e)).toList()
          as dynamic;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i7.HistoricalLocalDates) {
      return 'HistoricalLocalDates';
    }
    if (data is _i8.HistoricalMois) {
      return 'HistoricalMois';
    }
    if (data is _i9.Organisations) {
      return 'Organisations';
    }
    if (data is _i10.Pays) {
      return 'Pays';
    }
    if (data is _i11.People) {
      return 'People';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'HistoricalLocalDates') {
      return deserialize<_i7.HistoricalLocalDates>(data['data']);
    }
    if (data['className'] == 'HistoricalMois') {
      return deserialize<_i8.HistoricalMois>(data['data']);
    }
    if (data['className'] == 'Organisations') {
      return deserialize<_i9.Organisations>(data['data']);
    }
    if (data['className'] == 'Pays') {
      return deserialize<_i10.Pays>(data['data']);
    }
    if (data['className'] == 'People') {
      return deserialize<_i11.People>(data['data']);
    }
